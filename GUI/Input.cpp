...
ActionType Input::GetUserAction() const
{
	...
	if (UI.InterfaceMode == MODE_DRAW)	//GUI in the DRAW mode
	{
		...
		if (y >= 0 && y < UI.ToolBarHeight)
		{
			...
			case ITM_SQYARE:return DRAW_SQUARE;
			case ITM_TRINAGLE:return DRAW_TRIANGLE;
			case ITM_CIRCLE:return DRAW_CIRCLE;
			case ITM_HEXAGON:return DRAW_HEXAGON;
			case ITM_SELECT:return SELECT;
			case ITM_SWAP:return SWAP;
			case ITM_ROTATE:return ROTATE_FIGURE;
			case ITM_DELETE:return DELETE_FIGURE;
			case ITM_CLEARALL:return CLEAR_ALL;
			case ITM_COPY:return COPY_FIGURE;
			case ITM_CUT:return CUT_FIGURE;
			case ITM_PASTE:return PASTE_FIGURE;
...
//==> This assumes that menu items are lined up horizontally <==
			...
			case ITM_RESTART_THE_GAME:return RESTART_THE_GAME;
			...
			//return TO_PLAY;	//just for now. This shou+ld be updated	
